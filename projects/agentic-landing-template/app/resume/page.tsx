...
export default function ResumePage() {
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/Rod_Raemon_Alvero_Resume.pdf" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2" download>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-grow">
                ...
                <div className="flex gap-3 mt-6">
                  <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-colors">
                  ...
                  {/* Portfolio link commented out for now */}
            ...
            <div className="space-y-8">
              ...
              <div className="relative pl-8 pb-8 border-l-2 border-blue-200 dark:border-blue-800">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-3">
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">Senior Software Engineer</h3>
                    <p className="text-blue-600 dark:text-blue-400 font-medium">Tech Solutions Inc. (2023–Present)</p>
                  </div>
                ...
                <ul className="space-y-2 text-slate-600 dark:text-slate-400">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Led</strong> a team of 3 engineers in developing a new customer relationship management (CRM) platform, resulting in a 20% increase in sales efficiency.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" />
                    </svg>
                    <span><strong>Designed and implemented</strong> RESTful APIs using Node.js and Express.js, handling over 1 million requests daily.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" />
                    </svg>
                    <span><strong>Mentored</strong> junior developers, improving team code quality and development practices.</span>
                  </li>
                </ul>
                <div className="flex flex-wrap gap-2 mt-4">
                  {['React', 'TypeScript', 'AWS', 'Node.js', 'Express.js'].map((tech) => (
              ...
              <div className="relative pl-8 pb-8 border-l-2 border-slate-200 dark:border-slate-700">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-3">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 font-medium">Innovate Corp. (2020–2023)</p>
                  </div>
                  <div className="text-sm text-slate-500 whitespace-nowrap">
                    2020 - 2023 • San Diego, CA
                  </div>
                </div>
                <ul className="space-y-2 text-slate-600 dark:text-slate-400">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Developed and maintained</strong> features for a large-scale e-commerce platform using React and Redux.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" />
                    </svg>
                    <span><strong>Optimized</strong> application performance, reducing page load times by 15%.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" />
                    </svg>
                    <span><strong>Collaborated</strong> with product managers and UX/UI designers to translate requirements into technical specifications.</span>
                  </li>
                </ul>
                <div className="flex flex-wrap gap-2 mt-4">
                  {['React', 'Redux', 'JavaScript', 'Tailwind CSS'].map((tech) => (
                    <span key={tech} className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-2 py-1 rounded text-xs">
                      {tech}
                    </span>
                  ))}
              ...
              {/* Job 3 - Earlier Job (Placeholder for now) */}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['React', 'Next.js', 'Node.js', 'Express.js', 'Redux', 'Tailwind CSS', 'Jest', 'React Testing Library'].map((skill) => (
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['AWS', 'Google Cloud Platform', 'Docker', 'Kubernetes', 'Git', 'CI/CD'].map((skill) => (
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Git', 'Jira', 'Figma', 'Agile', 'Scrum', 'TDD', 'BDD'].map((skill) => (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-6">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-2">
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Master of Science in Computer Science</h3>
                    <p className="text-blue-600 dark:text-blue-400">University of Example</p>
                  </div>
                  <div className="text-sm text-slate-500">2020</div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-6">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-2">
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Bachelor of Science in Software Engineering</h3>
                    <p className="text-blue-600 dark:text-blue-400">State University</p>
                  </div>
                  <div className="text-sm text-slate-500">2018</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ============================================================ */}
      {/* PROJECTS (Optional) - Commented out for now                     */}
      {/* ============================================================ */}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/Rod_Raemon_Alvero_Resume.pdf"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm text-slate-600 dark:text-slate-400">
              © {new Date().getFullYear()} Rod Raemon Alvero. All rights reserved.
            </div>
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
